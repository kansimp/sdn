...
export default function UpdateBrandModal({ open, handleClose, setFlag, flag, brandId }) {
    ...
    const handleUpdate = async (values) => {
        const res = await axios.put('http://localhost:5000/brands', { brandName: values.brandName, brandId });
    };
